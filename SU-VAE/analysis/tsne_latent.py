...
from SU_VAE2 import CVAE4   #  28
# from SU_VAE2_BA23 import CVAE4         ####23
...
val_i1_dir = './data_chcp/eval/tsne/RSA_data'  ##28
val_i2_dir = './data_chcp/eval/tsne/RSA_data_m'
...
def val(model, val_loader1, val_loader2):
    ...
    for ti in range(10):
        ...
        """aaaaaaaaa"""
        with pd.ExcelWriter('./data_chcp/eval/tsne/rs/hms_ss0_'+ str(ti)+'.xlsx') as writer: # human_specific
            df1.to_excel(writer, sheet_name='Sheet1')
        with pd.ExcelWriter('./data_chcp/eval/tsne/rs/hms_ss1_'+str(ti)+'.xlsx') as writer:  # macaque_specific
            df2.to_excel(writer, sheet_name='Sheet1')
        with pd.ExcelWriter('./data_chcp/eval/tsne/rs/hms_zz1_'+str(ti)+'.xlsx') as writer:  # human_shared
            df3.to_excel(writer, sheet_name='Sheet1')
        with pd.ExcelWriter('./data_chcp/eval/tsne/rs/hms_zz2_' + str(ti) + '.xlsx') as writer:  # macaque_shared
